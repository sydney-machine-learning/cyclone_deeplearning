...
if ocean == 'south_indian':
    url_train = 'https://raw.githubusercontent.com/sydney-machine-learning/cyclone_deeplearning/main/data/SouthIndianOcean/misc/rawtrain1985-2001.txt'
    url_test = 'https://raw.githubusercontent.com/sydney-machine-learning/cyclone_deeplearning/main/data/SouthIndianOcean/misc/rawtest2006-2013.txt'
    train_limit = 9364
    hot_encoded_result_file_name = 'south_indian'
    category_result_file_name = 'roc_data_south_indian'
    
else:
    url_train = 'https://raw.githubusercontent.com/sydney-machine-learning/cyclone_deeplearning/main/data/SouthPacificOcean/misc/rawtrain1985-2005.txt'
    url_test = 'https://raw.githubusercontent.com/sydney-machine-learning/cyclone_deeplearning/main/data/SouthPacificOcean/misc/rawtest2006-2013.txt'
    train_limit = 6842 
    hot_encoded_result_file_name = 'south_pacific'
    category_result_file_name = 'roc_data_south_pacific' 
    
df = load_data(url_train)
...
rows = []
roc_avg_type = 'micro' #micro/macro

for j in range(1,7):
  for k in range(1,j+1):
        row = []
        for i in models:
            row.append(roc_data_train[str(j)][i][str(k)]['roc_auc'][roc_avg_type])
            row.append(roc_data_test[str(j)][i][str(k)]['roc_auc'][roc_avg_type])
        rows.append(row)
...
df.to_csv('roc_' + roc_avg_type + ocean + '.csv')
print('done')
